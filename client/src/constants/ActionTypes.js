...
export const UPDATE_PROJECT_P = "update_project_p";
...
export const GET_ALL_QUOTES_FROM_DATABASE_RECEIVED =
  "get_all_quotes_from_database_received";
export const GET_QUOTE_DETAILS_FROM_DATABASE =
  "get_quote_details_from_database";
export const GET_QUOTE_DETAILS_FROM_DATABASE_RECEIVED =
  "get_quote_details_from_database_received";
...
export const GET_ALL_ACTIVES_QUOTES_FROM_DATABASE =
  "get_all_active_quotes_from_database";
export const GET_ALL_ACTIVES_QUOTES_FROM_DATABASE_RECEIVED =
  "get_all_active_quotes_from_database_received";
...
export const GET_USERS_WITH_QUOTES_ACTION_RECEIVED =
  "get_users_with_quotes_action_received";
export const GET_USER_WITH_QUOTE_ACTION = "get_user_with_quote_action";
export const GET_USER_WITH_QUOTE_ACTION_RECEIVED =
  "get_user_with_quote_action_received";
